...
class Person(models.Model):
    company = models.ForeignKey(Company,on_delete=models.PROTECT,verbose_name='会社名')
    section = models.ForeignKey(Section,on_delete=models.SET_NULL,null=True,verbose_name='部署名')
    name = models.CharField('担当者名',max_length=255)
    search_name = models.CharField(max_length=255,null=True)
    zip_code = models.CharField('郵便番号',max_length=255,null=True)
    address_1 = models.CharField('住所',max_length=255,null=True)
    address_2 = models.CharField('',max_length=255,null=True)
    address_3 = models.TextField('')
    telephone_number_1 = models.CharField('電話番号',max_length=255,null=True)
    telephone_number_2 = models.CharField('',max_length=255,null=True)
    fax_number = models.CharField('FAX番号',max_length=255,null=True)
    mail_address = models.CharField('メールアドレス',max_length=255,null=True)
    person_role_name = models.CharField('役職名',max_length=255,null=True)
    retier_flg = models.BooleanField('退職',default=False)
    retier_date = models.DateField('退職日',null=True)
    note = models.TextField('備考',null=True,blank=True)
    delete_flg = models.BooleanField(default=False)
    create_user = models.CharField(max_length=255)
    create_date = models.DateTimeField(auto_now_add=True)
